...
try:    
    ...
    with col1:
        st.header(f"Pregúntale a JuriChat - Sección Laboral 💻")
    with col2:
    ...
    st.markdown(
        ...
        con la legislación laboral, como el Código de Trabajo, Ley de Pensiones y otras normativas 
        que protegen los derechos y deberes en el ámbito laboral. Realiza consultas rápidas y 
        encuentra explicaciones claras sobre leyes que regulan temas como beneficios para empleados, 
        pensiones, salario laboral, y más ​💙​🦾​.        
